...
const getOrderByFilter = (
  previousPage: GetNamesForAddressParameters['previousPage'],
  orderDirection: GetNamesForAddressParameters['orderDirection'],
  orderBy: GetNamesForAddressParameters['orderBy'],
) => {
